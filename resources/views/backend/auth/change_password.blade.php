...
{{--                    <h4 class="uppercase">update password Here</h4>--}}
{{--                </div>--}}
                <form class="card mt-5 p-5 md:p-10" action="{{route('change_password_post')}}" method="POST" id="update_password1">
                    @csrf
{{--                    <div class="mb-5">--}}
...
{{--                    </div>--}}
                    <div class="mb-5">
                        ...
                        @if($errors->has('new_password'))
                            <span class="invalid-feedback" role="alert">
                                 <strong>password at least 6 character </strong>
                            </span>
                        @endif
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        @if($errors->has('confirm_password'))
                            <span class="invalid-feedback" role="alert">
                               <strong>confirm password dose not matched </strong>
                            </span>
                        @endif
                    </div>
...
@section('script')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\UpdatePassword', '#update_password'); !!}
@endsection
