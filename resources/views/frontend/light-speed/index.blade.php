...
@section('content')
            ...
            <div class="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
                <div class="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5">
                    <div class="max-w-xl mb-6">
                        <h1 class="text-main font-bold text-sm">A WORLD-CLASS MOBILE APP</h1>
                        <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-black sm:text-6xl sm:leading-none">
                            for your <span class="text-main">Lightspeed</span> store
                        </h2>
                        <p class="text-base text-gray-700 md:text-lg">
                            Better mobile experiences lead to happier customers and more revenue. With our Lightspeed
                    ...
                    <div class="relative w-full p-3 rounded  md:p-8">
                        <div class="rounded-lg text-black w-full">
                            <img class="rounded-3xl"
                                 src="{{asset('assets/light-speed/ecommerceappsbackground-1140x855.jpg')}}">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section>
        @include('frontend.light-speed.proven-app')
    </section>

    <section>
        @include('frontend.light-speed.expand-brand')
    </section>

    <section>
        @include('frontend.light-speed.plugin-integration')
    </section>

    <section>
        @include('frontend.light-speed.premium-app-experience')
    </section>

    <section>
        @include('frontend.light-speed.seamless-ux')
    </section>

    <section>
        @include('frontend.light-speed.wow-customer')
    </section>

    <section>
        @include('frontend.light-speed.native-checkout')
    </section>

    <section>
        @include('frontend.light-speed.quotes')
    </section>


    <section>
        @include('frontend.light-speed.proven-app-jmango')
    </section>

    <section>
        @include('frontend.light-speed.brand-carosel')
    </section>

    <section>
        @include('frontend.light-speed.no-cdoe')
    </section>

    <section>
        @include('frontend.light-speed.jmango')
    </section>
@endsection
