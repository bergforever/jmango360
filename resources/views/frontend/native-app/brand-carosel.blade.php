    ...
    <div class="slider-brand pt-8 pb-48">
        ...
        <div class="grid grid-cols-3 gap-2">
            ...
            <div class="lg:col-span-2 md:col-span-2 col-span-3">
                <h1 class="text-center text-white lg:text-xl md:text-xl font-inherit lg:mx-0 md:mx-0 mx-2"><b>THE #1 MOBILE APP PLATFORM USED BY BRANDS ALL OVER THE WORLD</b></h1>
            </div>
        </div>
    </div>
</section>
