...
@section('content')
                ...
                <div class="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5">
                    <div class="max-w-xl mb-6">
                        ...
                        <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-black sm:text-6xl sm:leading-none">
                            for your <span class="text-main">Shopify</span> store
                        </h2>
                        <p class="text-base text-gray-700 md:text-lg">
                            Better mobile experiences lead to happier customers and more revenue. With our Shopify
                ...
                <div class="flex items-center justify-center lg:w-1/2">
                    <div class="relative w-full p-3 rounded  md:p-8">
                        <div class="rounded-lg text-black w-full">
                            <img class="" src="{{asset('assets/shopify/shopify_int.png')}}">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section>
        @include('frontend.shopify.proven-app')
    </section>

    <section>
        @include('frontend.shopify.expand-brand')
    </section>

    <section>
        @include('frontend.shopify.plugin-integration')
    </section>

    <section>
        @include('frontend.shopify.premium-app-experience')
    </section>

    <section>
        @include('frontend.shopify.seamless-ux')
    </section>

    <section>
        @include('frontend.shopify.wow-customer')
    </section>

    <section>
        @include('frontend.shopify.native-checkout')
    </section>

    <section>
        @include('frontend.shopify.quotes')
    </section>


    <section>
        @include('frontend.shopify.proven-app-jmango')
    </section>

    <section>
        @include('frontend.shopify.brand-carosel')
    </section>

    <section>
        @include('frontend.shopify.no-code')
    </section>

    <section>
        @include('frontend.shopify.jmango')
    </section>
@endsection
