...
@section('content')
                ...
                <div class="flex items-center justify-center lg:w-1/2">
                    <div class="relative w-full p-3 rounded  md:p-8">
                        <div class="rounded-lg text-black w-full">
                            <img class="" src="{{asset('assets/others-img/subdued-showcase-home.png')}}">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section>
        @include('frontend.others-native-app.graph-chart')
    </section>

    <section>
        @include('frontend.others-native-app.mobile-visitors')
    </section>

    <section>
        @include('frontend.others-native-app.stand-crowd')
    </section>

    <section>
        @include('frontend.others-native-app.native-app')
    </section>

    <section>
        @include('frontend.others-native-app.cart-abandonment')
    </section>

    <section>
        @include('frontend.others-native-app.shopping-experience')
    </section>

    <section>
        @include('frontend.others-native-app.webstore')
    </section>

    <section>
        @include('frontend.others-native-app.manage-effort')
    </section>

    <section>
        @include('frontend.others-native-app.favourite-ecommerce')
    </section>


    <section>
        @include('frontend.others-native-app.marketing-support')
    </section>

    <section>
        @include('frontend.others-native-app.second-quotes')
    </section>
    <section>
        @include('frontend.others-native-app.brand-carosel')
    </section>

    <section>
        @include('frontend.others-native-app.clients-review')
    </section>

    <section>
        @include('frontend.others-native-app.jmango')
    </section>
@endsection
