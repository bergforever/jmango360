<section>
    <section class="relative lg:mt-0 md:mt-0 mt-32 pt-18 lg:pb-6 md:pb-36 pb-20 bg-blueGray-100 overflow-hidden">
        <div class="relative z-10 container px-4 mx-auto">
            <div class="w-11/12 xl:w-2/3 lg:w-2/3 md:w-2/3 mx-auto sm:mb-10 mb-16">
                <h1 tabindex="0" class="focus:outline-none xl:text-4xl md:text-3xl text-2xl text-center text-custom font-extrabold mb-5 pt-4">Partnerships with Coveted Brands</h1>
                <p tabindex="0" class="focus:outline-none text-base md:text-lg lg:text-xl text-center text-gray-900 font-normal xl:w-10/12 xl:mx-auto">THE #1 MOBILE APP PLATFORM USED BY BRANDS ALL OVER THE WORLD</p>
            </div>
