<section class="">
    <div class="px-4 lg:pb-2 md:pb-2 lg:pt-2 md:pt-2 pt-10   mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-2">
                ...
                <div class="relative w-full p-3 rounded  md:p-8">
                    <div class="rounded-lg text-black w-full">
                        <img class="rounded-3xl"
                             src="{{asset('assets/b2b-bigcommerce/bc-portal-tablet.png')}}">
                    </div>
                </div>
            </div>
            <div class="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5">
                <div class="max-w-xl mb-6">
                    <h1 class="text-main font-bold text-sm">COMPANY SHOPPING LIST</h1>
                    <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-black sm:text-4xl sm:leading-none">
                        Create wish lists for your company
                    </h2>
                    <p class="text-base text-gray-700 md:text-lg">
                        It is possible to create and manage shopping lists for the company. This is suitable for
                        business customers who frequently order a certain product range from the merchant/supplier.
                </div>
