        ...
        <div class="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
            <div class="mb-2 lg:mb-0 lg:max-w-lg lg:pr-5">
                <div class="max-w-xl mb-6">
                    <h1 class="text-main font-bold text-sm">CUSTOMISABLE WEB OR MOBILE APP UI</h1>
                    ...
                    <p class="text-base text-gray-700 md:text-lg">
                        Our solution is architectured to have a separate front end user interface and backend system
                        APIs. This allows further customisation of the user interface as per business requirements. We
                        understand that individual merchants may have variations of ordering process and presentation of
            ...
            <div class="flex items-center justify-center lg:w-1/2">
                <div class="relative w-full h-full p-3 rounded  md:p-8">
                    <div class="rounded-lg text-black w-full h-full">
                        <img class="rounded-3xl"
                             src="{{asset('assets/b2b-bigcommerce/bc-customize.png')}}">
                    </div>
                </div>
            </div>
        </div>
