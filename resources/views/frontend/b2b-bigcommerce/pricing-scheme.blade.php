        ...
        <div class="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
            <div class="mb-2 lg:mb-0 lg:max-w-lg lg:pr-5">
                <div class="max-w-xl mb-6">
                    <h1 class="text-main font-bold text-sm">CUSTOM PRICING/GROUPS</h1>
                    ...
                    <p class="text-base text-gray-700 md:text-lg">
                        JMango360 B2B solution utilises BigCommerce Price List and Customer Groups to present this to
                        the end user. Each business customer is considered as a company, there can be multiple
                        BigCommerce users associated with a company and having different roles. A company is
                        subsequently associated with a customer group.
                </div>
                ...
                <div class="relative w-full p-3 rounded  md:p-8">
                    <div class="rounded-lg text-black w-full">
                        <img class="rounded-3xl"
                             src="{{asset('assets/b2b-bigcommerce/bc-portal-screen.png')}}">
                    </div>
                </div>
            </div>
        </div>
