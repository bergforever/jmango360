<section class="">
    <div class="px-4 py-1 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-2">
                ...
                <div class="relative w-full p-3 rounded  md:p-8">
                    <div class="rounded-lg text-black w-full">
                        <img class="rounded-3xl"
                             src="{{asset('assets/b2b-bigcommerce/smartmockups_l8iu0c8i.png')}}">
                    </div>
                </div>
            </div>
            <div class="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5">
                <div class="max-w-xl mb-6">
                    <h1 class="text-main font-bold text-sm">BULK ORDERING</h1>
                    ...
                    <p class="text-base text-gray-700 md:text-lg">
                        B2B orders are quite different then consumer orders. While consumers order one item at a time
                        and only for them selves, business consumers order products in different sizes, colors and
                        options to resell in their stores. Easy bulk ordering options save a lot of time and
                        frustration.
                </div>
