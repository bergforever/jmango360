            ...
            <div class="relative inline-flex items-center mx-auto align-middle">
                <div class="text-center">
                    <h1 class="max-w-5xl text-2xl font-bold leading-none tracking-tighter text-neutral-600 md:text-5xl lg:text-5xl lg:max-w-4xl">
                        <span class="text-white">Go for premium, nothing less. Grow with JMango360</span>
                    </h1>
                    <p class="max-w-xl mx-auto mt-8 text-base leading-relaxed text-white text-center">
            ...
            <div class="relative inline-flex items-center mx-auto align-middle">
                <div class="text-center">
                    <div class="mt-5 sm:flex md:mt-8">
                        <div class="">
                            <button class="bg-white rounded-full lg:px-10 lg:py-5 md:px-10 md:py-5 px-4 py-3 lg:mb-0 md:mb-0 mb-4 text-black border font-semibold">
                        ...
                        <div class="mt-3  sm:mt-0 sm:ml-3">
                            <button class="bg-white hover:bg-white group-hover:opacity-80 lg:px-10 lg:py-5 md:px-10 md:py-5 px-4 py-3 text-black   rounded-full font-semibold">
                                <div class="flex gap-3 justify-center items-center">
...
<section class="py-5 lg:py-[120px]">
    <div class="mx-4">
        <div
            class="
            bg-main
        ...
        >
            <div class="flex -mx-4">
                <div class="w-full px-4">
                    <div class="max-w-[570px] mx-auto text-center">
                  ...
                  "
                        >
                            Make mobile your best performing channel.
                        </p>
                        <div
                            class="lg:mt-0 md:mt-2 mt-2 relative items-center w-full px-5 lg:pt-5 pb-1 mx-auto md:px-12 lg:px-8 max-w-7xl lg:py-2">
                            <div class="flex w-full mx-auto text-left">
                                <div class="relative inline-flex items-center mx-auto align-middle">
                                    <div class="text-center">
                                        <div class="mt-5 sm:flex md:mt-4">
                                                   ...
                                                   class="flex flex-row items-center hover:bg-white hover:text-main text-white justify-center w-full px-4 py-4 mb-4 text-sm font-bold  leading-6 capitalize duration-100 border-white border-2 transform rounded-lg shadow cursor-pointer focus:ring-4 focus:ring-mainfocus:ring-opacity-50 focus:outline-none sm:mb-0 sm:w-auto sm:mr-4 md:pl-8 md:pr-6 xl:pl-12 xl:pr-10   hover:shadow-lg hover:-translate-y-1">
                                                    ...
                                                    <span class="ml-4">
                                                        <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
                                                             viewBox="0 0 24 24" class="w-5 h-5 fill-current"><path
                                                                fill="currentColor"
