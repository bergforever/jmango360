    ...
    <div class="container flex flex-col px-6 py-10 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
        <div class="w-full lg:w-2/5">
            <div class="lg:max-w-lg">
                <p class="font-bold text-xs">THE BEST UX</p>
                <h1 class="text-3xl font-bold tracking-wide text-main lg:text-4xl">
                    More loyalty
                </h1>
                <br>
                <p>Offer your customers a magazine-like shopping experience. Optimized search, smart navigation and
                    recommendations will take mobile shopping from good to great.</p>
                ...
                <div class="mt-8 space-y-5 justify-end items-end text-right">
                    ...
                    <p class="ml-8 text-left">Easy filter and sorting</p>
                    </p>
                    ...
                    <p class="ml-8 text-left">Smart recommendations and most relevant results</p>
                    </p>
                    ...
                    <p class="flex items-center -mx-2 text-gray-700 dark:text-gray-200">
                        ...
                        <span class="mx-2 text-black text-left font-bold">Shop-able look-books</span>
                    <p class="ml-8 text-left">Shop-able look-books make your customers drool</p>
                    </p>
        ...
        <div class="flex items-center justify-center w-full h-full lg:w-3/5">
            <img class="w-[80%] h-full" src="{{asset('assets/supplement-img/fashion-page.png')}}" alt="">
        </div>
    </div>
</section>
