    ...
    return function () {
        ...
        var t = {
            647: function (t, e, i) {
                ...
                var n = "top", o = "bottom", r = "right", s = "left", a = "auto", c = [n, o, r, s], l = "start",
                    d = "end", u = "clippingParents", p = "viewport", f = "popper", h = "reference",
                    g = c.reduce((function (t, e) {
                        return t.concat([e + "-" + l, e + "-" + d])
                    }), []), v = [].concat(c, [a]).reduce((function (t, e) {
                        return t.concat([e, e + "-" + l, e + "-" + d])
                    }), []), m = "beforeRead", y = "read", _ = "afterRead", b = "beforeMain", w = "main", E = "afterMain",
                    L = "beforeWrite", O = "write", x = "afterWrite", k = [m, y, _, b, w, E, L, O, x];
                ...
                function V(t, e, i) {
                    ...
                    var s = (j(t) ? T(t) : window).visualViewport, a = !B() && i,
                        c = (n.left + (a && s ? s.offsetLeft : 0)) / o, l = (n.top + (a && s ? s.offsetTop : 0)) / r,
                        d = n.width / o, u = n.height / r;
                ...
                var Z = {
                    name: "arrow", enabled: !0, phase: "main", fn: function (t) {
                        var e, i = t.state, a = t.name, l = t.options, d = i.elements.arrow,
                            u = i.modifiersData.popperOffsets, p = D(i.placement), f = Y(p),
                        ...
                        if (d && u) {
                            var g = function (t, e) {
                                ...
                                }(l.padding, i), v = W(d), m = "y" === f ? n : s, y = "y" === f ? o : r,
                                _ = i.rects.reference[h] + i.rects.reference[f] - u[f] - i.rects.popper[h],
                                b = u[f] - i.rects.reference[f], w = X(d),
                                E = w ? "y" === f ? w.clientHeight || 0 : w.clientWidth || 0 : 0, L = _ / 2 - b / 2,
                                O = g[m], x = E - v[h] - g[y], k = E / 2 - v[h] / 2 + L, A = G(O, k, x), T = f;
                ...
                function et(t) {
                    var e, i = t.popper, a = t.popperRect, c = t.placement, l = t.variation, u = t.offsets,
                        p = t.position, f = t.gpuAcceleration, h = t.adaptive, g = t.roundOffsets, v = t.isFixed,
                        m = u.x, y = void 0 === m ? 0 : m, _ = u.y, b = void 0 === _ ? 0 : _,
                        w = "function" == typeof g ? g({x: y, y: b}) : {x: y, y: b};
                    y = w.x, b = w.y;
                    var E = u.hasOwnProperty("x"), L = u.hasOwnProperty("y"), O = s, x = n, k = window;
                    if (h) {
                        var A = X(i), j = "clientHeight", P = "clientWidth";
                    ...
                    var C, S = Object.assign({position: p}, h && tt), D = !0 === g ? function (t) {
                        var e = t.x, i = t.y, n = window.devicePixelRatio || 1;
                        return {x: q(e * n) / n || 0, y: q(i * n) / n || 0}
                    }({x: y, y: b}) : {x: y, y: b};
                    return y = D.x, b = D.y, f ? Object.assign({}, S, ((C = {})[x] = L ? "0" : "", C[O] = E ? "0" : "", C.transform = (k.devicePixelRatio || 1) <= 1 ? "translate(" + y + "px, " + b + "px)" : "translate3d(" + y + "px, " + b + "px, 0)", C)) : Object.assign({}, S, ((e = {})[x] = L ? b + "px" : "", e[O] = E ? y + "px" : "", e.transform = "", e))
                }

                var it = {
                    name: "computeStyles", enabled: !0, phase: "beforeWrite", fn: function (t) {
                        var e = t.state, i = t.options, n = i.gpuAcceleration, o = void 0 === n || n, r = i.adaptive,
                            s = void 0 === r || r, a = i.roundOffsets, c = void 0 === a || a, l = {
                ...
                var ot = {
                    name: "eventListeners", enabled: !0, phase: "write", fn: function () {
                        ...
                        var e = t.state, i = t.instance, n = t.options, o = n.scroll, r = void 0 === o || o,
                            s = n.resize, a = void 0 === s || s, c = T(e.elements.popper),
                ...
                function ft(t, e) {
                    var i;
                    void 0 === e && (e = []);
                    var n = pt(t), o = n === (null == (i = t.ownerDocument) ? void 0 : i.body), r = T(n),
                ...
                function gt(t, e, i) {
                    return e === p ? ht(function (t, e) {
                        var i = T(t), n = N(t), o = i.visualViewport, r = n.clientWidth, s = n.clientHeight, a = 0,
                            c = 0;
                        if (o) {
                        ...
                        var e, i = N(t), n = lt(t), o = null == (e = t.ownerDocument) ? void 0 : e.body,
                            ...
                            a = -n.scrollLeft + dt(t), c = -n.scrollTop;
                ...
                function vt(t, e, i, n) {
                    var o = "clippingParents" === e ? function (t) {
                        var e = ft(K(t)), i = ["absolute", "fixed"].indexOf(R(t).position) >= 0 && P(t) ? X(t) : t;
                        return j(i) ? e.filter((function (t) {
                            return j(t) && z(t, i) && "body" !== A(t)
                        })) : []
                    }(t) : [].concat(e), r = [].concat(o, [i]), s = r[0], a = r.reduce((function (e, i) {
                        var o = gt(t, i, n);
                ...
                function mt(t) {
                    var e, i = t.reference, a = t.element, c = t.placement, u = c ? D(c) : null, p = c ? $(c) : null,
                        f = i.x + i.width / 2 - a.width / 2, h = i.y + i.height / 2 - a.height / 2;
                    switch (u) {
                        case n:
                ...
                function yt(t, e) {
                    void 0 === e && (e = {});
                    var i = e, s = i.placement, a = void 0 === s ? t.placement : s, l = i.strategy,
                        d = void 0 === l ? t.strategy : l, g = i.boundary, v = void 0 === g ? u : g, m = i.rootBoundary,
                        y = void 0 === m ? p : m, _ = i.elementContext, b = void 0 === _ ? f : _, w = i.altBoundary,
                        E = void 0 !== w && w, L = i.padding, O = void 0 === L ? 0 : L,
                        x = J("number" != typeof O ? O : Q(O, c)), k = b === f ? h : f, A = t.rects.popper,
                        T = t.elements[E ? k : b], P = vt(j(T) ? T : T.contextElement || N(t.elements.popper), v, y, d),
                        C = V(t.elements.reference),
                        S = mt({reference: C, element: A, strategy: "absolute", placement: a}),
                        D = ht(Object.assign({}, A, S)), I = b === f ? D : C, M = {
                            top: P.top - I.top + x.top,
                            bottom: I.bottom - P.bottom + x.bottom,
                            left: P.left - I.left + x.left,
                            right: I.right - P.right + x.right
                ...
                var _t = {
                    name: "flip", enabled: !0, phase: "main", fn: function (t) {
                        ...
                        if (!e.modifiersData[d]._skip) {
                            for (var u = i.mainAxis, p = void 0 === u || u, f = i.altAxis, h = void 0 === f || f, m = i.fallbackPlacements, y = i.padding, _ = i.boundary, b = i.rootBoundary, w = i.altBoundary, E = i.flipVariations, L = void 0 === E || E, O = i.allowedAutoPlacements, x = e.options.placement, k = D(x), A = m || (k === x || !L ? [st(x)] : function (t) {
                                if (D(t) === a) return [];
                                var e = st(t);
                                return [ct(t), e, ct(e)]
                                ...
                                return t.concat(D(i) === a ? function (t, e) {
                                    void 0 === e && (e = {});
                                    var i = e, n = i.placement, o = i.boundary, r = i.rootBoundary, s = i.padding,
                                        a = i.flipVariations, l = i.allowedAutoPlacements, d = void 0 === l ? v : l,
                                        u = $(n), p = u ? a ? g : g.filter((function (t) {
                                            return $(t) === u
                            ...
                            }), []), j = e.rects.reference, P = e.rects.popper, C = new Map, S = !0, I = T[0], M = 0; M < T.length; M++) {
                                var q = T[M], H = D(q), B = $(q) === l, V = [n, o].indexOf(H) >= 0,
                                    W = V ? "width" : "height",
                ...
                var Et = {
                    ...
                    fn: function (t) {
                        var e = t.state, i = t.name, n = e.rects.reference, o = e.rects.popper,
                            r = e.modifiersData.preventOverflow, s = yt(e, {elementContext: "reference"}),
                            a = yt(e, {altBoundary: !0}), c = bt(s, n), l = bt(a, o, r), d = wt(c), u = wt(l);
                        e.modifiersData[i] = {
                ...
                var Lt = {
                    name: "offset", enabled: !0, phase: "main", requires: ["popperOffsets"], fn: function (t) {
                        var e = t.state, i = t.options, o = t.name, a = i.offset, c = void 0 === a ? [0, 0] : a,
                            l = v.reduce((function (t, i) {
                                return t[i] = function (t, e, i) {
                                    var o = D(t), a = [s, n].indexOf(o) >= 0 ? -1 : 1,
                                        c = "function" == typeof i ? i(Object.assign({}, e, {placement: t})) : i,
                                        l = c[0], d = c[1];
                                    return l = l || 0, d = (d || 0) * a, [s, r].indexOf(o) >= 0 ? {x: d, y: l} : {
                                        x: l,
                                        y: d
                                    }
                                }(i, e.rects, c), t
                ...
                var xt = {
                    name: "preventOverflow", enabled: !0, phase: "main", fn: function (t) {
                        var e = t.state, i = t.options, a = t.name, c = i.mainAxis, d = void 0 === c || c,
                            u = i.altAxis, p = void 0 !== u && u, f = i.boundary, h = i.rootBoundary, g = i.altBoundary,
                            v = i.padding, m = i.tether, y = void 0 === m || m, _ = i.tetherOffset,
                            b = void 0 === _ ? 0 : _,
                            w = yt(e, {boundary: f, rootBoundary: h, padding: v, altBoundary: g}), E = D(e.placement),
                            L = $(e.placement), O = !L, x = Y(E), k = "x" === x ? "y" : "x",
                            A = e.modifiersData.popperOffsets, T = e.rects.reference, j = e.rects.popper,
                            P = "function" == typeof b ? b(Object.assign({}, e.rects, {placement: e.placement})) : b,
                            C = "number" == typeof P ? {mainAxis: P, altAxis: P} : Object.assign({
                                mainAxis: 0,
                                altAxis: 0
                            }, P), S = e.modifiersData.offset ? e.modifiersData.offset[e.placement] : null,
                            q = {x: 0, y: 0};
                        if (A) {
                            if (d) {
                                var H, B = "y" === x ? n : s, V = "y" === x ? o : r, z = "y" === x ? "height" : "width",
                                    R = A[x], F = R + w[B], N = R - w[V], K = y ? -j[z] / 2 : 0,
                                    U = L === l ? T[z] : j[z], J = L === l ? -j[z] : -T[z], Q = e.elements.arrow,
                                    ...
                                    tt = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : {
                                        ...
                                        bottom: 0,
                                        left: 0
                                    }, et = tt[B], it = tt[V], nt = G(0, T[z], Z[z]),
                                    ...
                                    ct = null != (H = null == S ? void 0 : S[x]) ? H : 0, lt = R + rt - ct,
                                    dt = G(y ? M(F, R + ot - ct - at) : F, R, y ? I(N, lt) : N);
                                A[x] = dt, q[x] = dt - R
                            }
                            if (p) {
                                var ut, pt = "x" === x ? n : s, ft = "x" === x ? o : r, ht = A[k],
                                    gt = "y" === k ? "height" : "width", vt = ht + w[pt], mt = ht - w[ft],
                                    _t = -1 !== [n, s].indexOf(E),
                ...
                function kt(t, e, i) {
                    ...
                    var n, o, r = P(e), s = P(e) && function (t) {
                        var e = t.getBoundingClientRect(), i = q(e.width) / t.offsetWidth || 1,
                            n = q(e.height) / t.offsetHeight || 1;
                        return 1 !== i || 1 !== n
                    }(e), a = N(e), c = V(t, s, i), l = {scrollLeft: 0, scrollTop: 0}, d = {x: 0, y: 0};
                            ...
                            state: a, setOptions: function (i) {
                                ...
                                return a.orderedModifiers = s.filter((function (t) {
                                    ...
                                    if ("function" == typeof o) {
                                        var r = o({state: a, name: e, instance: d, options: n}), s = function () {
                                        };
                                        c.push(r || s)
                                    }
                                })), d.update()
                ...
                var Ct = Pt(), St = Pt({defaultModifiers: [ot, Ot, it, S, Lt, _t, xt, Z, Et]}),
                    Dt = Pt({defaultModifiers: [ot, Ot, it, S]})
            }, 902: function (t, e) {
                ...
                function r() {
                    document.querySelectorAll("[data-accordion]").forEach((function (t) {
                        var e = t.getAttribute("data-accordion"), i = t.getAttribute("data-active-classes"),
                            r = t.getAttribute("data-inactive-classes"), s = [];
                ...
                function r() {
                    document.querySelectorAll("[data-carousel]").forEach((function (t) {
                        var e = t.getAttribute("data-carousel-interval"),
                            i = "slide" === t.getAttribute("data-carousel"), r = [], s = 0;
                    ...
                    document.querySelectorAll("[data-dropdown-toggle]").forEach((function (t) {
                        ...
                        if (i) {
                            var n = t.getAttribute("data-dropdown-placement"),
                                ...
                                c = t.getAttribute("data-dropdown-trigger"), l = t.getAttribute("data-dropdown-delay");
                            new a(i, t, {
                ...
                var n = i(902), o = i(33), r = i(922), s = i(556), a = i(791), c = i(340), l = i(316), d = i(16),
                    u = i(903), p = i(247), f = i(671);
                    ...
                    document.querySelectorAll("[data-popover-target]").forEach((function (t) {
                        ...
                        if (i) {
                            var n = t.getAttribute("data-popover-trigger"),
                                o = t.getAttribute("data-popover-placement"), r = t.getAttribute("data-popover-offset");
                            new a(i, t, {
        ...
        return function () {
            ...
            var e = i(902), o = i(33), r = i(922), s = i(556), a = i(791), c = i(340), l = i(316), d = i(16),
                u = i(903), p = i(247), f = i(671);
            i(311);
            var h = i(947);
